        ...
        <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            ...
            <div className="bg-white shadow rounded p-6 flex flex-col items-center text-center">
              <div className="mb-4 text-black text-4xl">
                <IconPackage size={40} />
              </div>
              ...
              <p className="text-gray-600">
                Bersihkan dan kemas produk Anda dengan baik. Ambil foto yang
                jelas dan siapkan detail produk.
              </p>
            </div>
            ...
            <div className="bg-white shadow rounded p-6 flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                Cari agen resmi kami menggunakan peta di bawah ini dan kunjungi
                lokasi mereka.
              </p>
            </div>
            ...
            <div className="bg-white shadow rounded p-6 flex flex-col items-center text-center">
              ...
              <p className="text-gray-600">
                Temui agen kami untuk mengevaluasi produk Anda dan menyelesaikan
                pertukaran atau penjualan.
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-gray-200 h-64 md:h-full sm:h-64 flex items-center justify-center rounded">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.291353674568!2d108.4984679743097!3d-6.974911268297162!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e6f16a074ab8a2f%3A0x663810741bca29cc!2sUniversitas%20Kuningan!5e0!3m2!1sid!2sid!4v1741265966024!5m2!1sid!2sid"
                  width="100%"
                  height="100%"
                  loading="lazy"
                ></iframe>
